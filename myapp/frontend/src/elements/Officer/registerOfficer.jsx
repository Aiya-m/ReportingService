      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg mx-auto space-y-6">
        ...
        <div className="bg-orange-100 rounded-2xl p-6 sm:p-8 shadow-lg">
          ...
          <div className="space-y-5">
            ...
            <div>
              <label htmlFor="phoneNumber" className="block text-sm font-medium text-orange-800 mb-2">
            ...
            <div>
              <label htmlFor="idOfficer" className="block text-sm font-medium text-orange-800 mb-2">
            ...
            <div>
              <label htmlFor="department" className="block text-sm font-medium text-orange-800 mb-2">
                หน่วยงานที่สังกัด
              </label>
              <input
                type="text"
