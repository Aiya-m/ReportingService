                    ...
                    <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                        ...
                        <tbody>
                            ...
                            <tr key={item.id} className={index % 2 === 0 ? "bg-gray-100" : "bg-white"}>
                                ...
                                <td className="py-2 px-4">{item.officer_id}</td>
                                <td className="py-2 px-4">{item.citizen_id}</td>
                                <td className="py-2 px-4">{item.email}</td>
                                <td className="py-2 px-4">{item.username}</td>
                                <td className="py-2 px-4"><button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">เพิ่มเติม</button></td>
                            </tr>
                            ))}
                        </tbody>
                    </table>
